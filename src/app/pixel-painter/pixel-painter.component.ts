...
@Component({
  ...
  styleUrls: ['./pixel-painter.component.css']
})
export class PixelPainterComponent implements OnInit {
  ...
  private sketch = (p: any) => {
    ...
    p.setup = () => {
      ...
      let canvas = p.createCanvas(this.pixelCanvasSize+this.pixelDrawSize*2, this.pixelCanvasSize).parent('tile-editor-div');
    };
